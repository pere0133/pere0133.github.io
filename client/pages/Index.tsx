...
export default function Index() {
  ...
  return (
    <div className="min-h-screen neural-bg">
      ...
      <section className="pt-24 pb-16 px-6 floating-shapes data-particles relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-7xl main-title-code mb-6 leading-tight hero-enter">
              <span className="typewriter inline-block code-part">Transforming_Data_Into</span>
              <br />
              <span
                ref={intelligenceRef}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in-left">
              <h2 className="text-3xl md:text-4xl code-header-white mb-6">Research_Impact</h2>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 px-6 data-particles relative" style={{background: 'linear-gradient(135deg, rgba(255, 107, 53, 0.08), rgba(139, 93, 168, 0.12))'}}>
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-4xl matrix-header mb-6 fade-in-up">Lets_Collaborate</h2>
